...
function Contact() {
  ...
  const handleButtonClick=()=>{
    alert(' Hi user your booking form is successfully submited ');
  };
  return (
    <div>
...
<div className="row"><div className="col-lg-12 text-center p-5" style={{backgroundColor:'#F1F1F1'}}>
  <h1 style={{fontFamily:' Brush Script MT',fontSize:'50px'}}> Booking For Trip </h1>
  <br></br> <fieldset className='ww'  data-aos="flip-left"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="2000" style={{borderRadius:'20px'}}><br></br>
     <br></br>
     <br></br>
   <form onSubmit={handleSubmit}>
        ...
        <br></br>
        <br></br>
        <span style={{fontFamily:'times new roman',fontSize:'25px',fontWeight:'bold'}}>Place</span>
        <input type="text" name="place" onChange={handleForm} style={{backgroundColor:'white',fontSize:'20px',borderRadius:'20px',borderColor:'transparent'}}></input>
        <br></br>
        <br></br>
        <span style={{fontFamily:'times new roman',fontSize:'25px',fontWeight:'bold'}}>Days</span>
        <input type="number" name="day" onChange={handleForm} style={{backgroundColor:'white',fontSize:'20px',borderRadius:'20px',borderColor:'transparent'}}></input>
        <br></br>
        <br></br>
        <span style={{fontFamily:'times new roman',fontSize:'25px',fontWeight:'bold'}}>Car</span>
        <input type="number" name="Number" onChange={handleForm} style={{backgroundColor:'white',fontSize:'20px',borderRadius:'20px',borderColor:'transparent'}}></input>
        <br></br>
        <br></br>
        <span style={{fontFamily:'times new roman',fontSize:'25px',fontWeight:'bold'}}>Date</span>
