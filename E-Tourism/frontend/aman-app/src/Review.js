...
function Review() {
  ...
  const handleButtonClick=()=>{
    alert(' Hi user your review is successfully submited ');
  };
  return (
    <div>
 
<div className="row"><div className="col-lg-12 text-center p-5" style={{backgroundColor:'#F1F1F1'}}>
  <h1 style={{fontFamily:' Brush Script MT',fontSize:'50px'}}> Drop your review  </h1>
  <br></br>
  <center>
   <fieldset className='o'  data-aos="zoom-in"
   ...
   <br></br>
        ...
        <br></br>
        <br></br>
        <span style={{fontFamily:'times new roman',fontSize:'25px',fontWeight:'bold'}}>Review Please</span>
        ...
        <br></br>
        <br></br>
        <button type='submit' onClick={handleButtonClick} style={{borderRadius:'20px',backgroundColor:"skyblue",border:'transparent'}}><input type="submit" style={{backgroundColor:'skyblue',fontSize:'20px',borderRadius:'30px',borderColor:'transparent',fontWeight:'bold',fontFamily:'times new roman',color:'white' }}></input>
      </button>
       <br></br>
        <br></br>
        <br></br>
