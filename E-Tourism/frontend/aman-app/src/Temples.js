...
const Temp=()=>{
    return(
      ...
      <div class="row">
            ...
            <div class="col-lg-3 text-center p-3"> <img data-aos="fade-up" data-aos-duration="3000" src="https://scontent.fixc4-2.fna.fbcdn.net/v/t39.30808-6/275861797_1092906951490493_902240536899052955_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=3635dc&_nc_ohc=LOGfc0224aoAX8VAoA-&_nc_ht=scontent.fixc4-2.fna&oh=00_AfCKrgdei0IKoatzJKZyQYgOKHXbw213RrJjf4hq9GYo7A&oe=65E3F6F3"  style={{width:'350px',height:'600px',borderRadius:'2%',boxShadow:'10px 10px 10px black'}}/>
           </div>
